...
namespace ImporterPOS.WPF.ViewModels
{
    ...
    public partial class StoreViewModel : BaseViewModel
    {
        ...
        public StoreViewModel(IArticleService articleService, IStorageService storageService, Notifier notifier, IInventoryDocumentsService inventoryService, IGoodService goodService, IInventoryItemBasisService invItemService)
        {
